...
export class LiteYouTubeEmbed extends HTMLElement {
  videoId: string = "";
  playLabel: string = "";
  needsYTApi: boolean = false;
  ytApiPromise: Promise<void> | undefined = undefined;
  playerPromise: Promise<any> | undefined = undefined;
  ...
  async addYTPlayerIframe() {
    ...
    this.playerPromise = new Promise((resolve) => {
      const player = new window.YT.Player(videoPlaceholderEl, {
        width: "100%",
    ...
    setTimeout(() => {
      ...
      img.onload = (e) => {
        ...
        const noAvailablePoster =
          (e.target as HTMLImageElement).naturalHeight === 90 &&
          (e.target as HTMLImageElement).naturalWidth === 120;
