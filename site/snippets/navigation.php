...
<nav class="gap-x-lg font-heading flex flex-wrap items-center">
  ...
  <div class="absolute right-lg top-1/2 -translate-y-1/2 sm:relative sm:right-0 sm:top-0 sm:h-[36px] sm:min-w-[var(--docsearch-width,unset)] sm:translate-0 md:my-[-4px]" data-docsearch></div>
</nav>
