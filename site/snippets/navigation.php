...
<nav class="flex flex-wrap items-center" style="--color-link-hover: var(--color-accent);">
  <div class="flex-grow-1 mr-5">
    <a href="<?= $site->url() ?>" class="navbar-logo" aria-label="<?= t('home') ?>"<?php e($site->homePage()->isActive(), ' aria-current="page"') ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 185.6 247.5" class="inline h-[var(--text-3)]">
      ...
      <span class="ml-1 hidden sm:inline"><?= $site->title() ?></span>
    </a>
  </div>
  ...
  <div class="navbar-links">
    ...
    <a href="https://www.instagram.com/johannschopplich/" class="hidden sm:flex items-center">
      <?= asset('assets/img/remix-icons/instagram.svg')->read() ?>
    </a>

    <a href="https://github.com/johannschopplich" class="hidden sm:flex items-center">
      <?= asset('assets/img/remix-icons/github.svg')->read() ?>
    </a>
  </div>
</nav>
