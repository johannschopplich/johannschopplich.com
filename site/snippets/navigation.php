...
<nav class="gap-x-lg font-heading flex flex-wrap items-center">
  ...
  <div class="absolute right-lg top-1/2 -translate-y-1/2 sm:relative sm:right-0 sm:top-0 sm:h-$docsearch-height sm:min-w-$docsearch-width sm:translate-0 md:my-[-4px]" data-docsearch>
    <button type="button" class="DocSearch DocSearch-Button" aria-label="<?= t('generic.search') ?>"><span class="DocSearch-Button-Container"><svg width="20" height="20" class="DocSearch-Search-Icon" viewBox="0 0 20 20">
          <path d="M14.386 14.386l4.0877 4.0877-4.0877-4.0877c-2.9418 2.9419-7.7115 2.9419-10.6533 0-2.9419-2.9418-2.9419-7.7115 0-10.6533 2.9418-2.9419 7.7115-2.9419 10.6533 0 2.9419 2.9418 2.9419 7.7115 0 10.6533z" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg><span class="DocSearch-Button-Placeholder"><?= t('generic.search') ?></span></span></button>
  </div>
</nav>