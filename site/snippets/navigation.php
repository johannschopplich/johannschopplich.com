...
<nav class="navigation">
  <div class="mr-m">
    <a href="<?= $site->url() ?>" class="navbar-logo" aria-label="<?= t('home') ?>"<?php e($site->homePage()->isActive(), ' aria-current="page"') ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 185.6 247.5" style="height: var(--text-3);">
      ...
      <span class="ml-xxxs d-none sm:d-inline"><?= $site->title() ?></span>
    </a>
  </div>
  ...
  <div class="navigation-links">
    ...
    <a href="https://www.instagram.com/johannschopplich/" class="d-none sm:d-flex align-items-center">
      <?= asset('assets/img/remix-icons/instagram.svg')->read() ?>
    </a>

    <a href="https://github.com/johannschopplich" class="d-none sm:d-flex align-items-center">
