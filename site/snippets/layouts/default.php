...
<body class="min-h-[100svh] md:pt-sm" data-template="<?= $page->intendedTemplate()->name() ?>">
  ...
  <header
    class="sticky -top-px border-b border-b-transparent border-b-solid transition-border-color z-20 bg-white/50 bg-image-$gradient bg-[length:4px_4px] backdrop-blur-[8px] [&.is-pinned]:border-contrast-lower un-dark:bg-stone-900/50 un-dark:[&.is-pinned]:border-contrast-lowest"
