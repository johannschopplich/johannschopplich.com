...
<body class="min-h-[100svh] md:pt-sm" data-template="<?= $page->intendedTemplate()->name() ?>">
  ...
  <header
    class="sticky -top-px border-b border-b-transparent border-b-solid transition-border-color z-20 bg-[color-mix(in_srgb,var(--un-color-background)75%,transparent)] backdrop-blur-[8px] [&.is-pinned]:border-contrast-lower un-dark:[&.is-pinned]:border-contrast-lowest">
