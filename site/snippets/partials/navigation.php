...
<nav class="flex items-center gap-x-2 flex-wrap" style="--un-decoration-thickness: max(2px, 0.125em)">
  <a
    href="<?= $site->url() ?>"
    class="
      inline-flex items-center bg-theme-background halftone-bg pl-0.5 pr-0.75 pb-0.75 pt-1
  ...
  >
    <svg class="size-[1.1em]" viewBox="0 0 256 256" fill="currentColor" style="overflow: visible; stroke: var(--un-dithered-to, var(--un-color-background)); stroke-width: 64; paint-order: stroke fill;" aria-hidden="true">
