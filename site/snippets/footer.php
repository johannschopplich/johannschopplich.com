<footer class="content py-lg md:py-3xl sticky top-100vh bg-contrast-lower font-heading">
  <div class="mb-8xl -ml-2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 185.6 247.5" class="w-16 h-16">
