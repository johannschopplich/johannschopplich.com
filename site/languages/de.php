...
return [
    ...
    'translations' => [
        'languages.switch' => 'Read in English',
        ...
        'photography.more' => 'Mehr Fotografien',
        'packages' => 'Open Source',
        'packages.more' => 'Alle Packages',
        'packages.downloads' => 'Downloads / Monat',
        'cv.career' => 'Werdegang',
        'feed.title' => 'Johanns aktuellste Artikel',
